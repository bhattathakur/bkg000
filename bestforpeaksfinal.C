...
E-max=16384*0.3890-0.1544=6373
  ...
  TFile *file=new TFile("comb0.root","RECREATE");
  TH1F *histo=new TH1F("histo","#font[22]{Calibrated Energy Spectrum}",16384,-0.71973,6365.65);
   while(1)
    {
  ...
  ifstream gussedParameter("gussedParameterfinal.dat");
